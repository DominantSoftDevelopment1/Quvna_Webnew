...
function normalizeProfileRow(raw: Record<string, unknown> | null | undefined) {
  ...
  return {
    ...raw,
    country: countryDisplay || (raw.country as string | undefined),
    birthDate: raw.birthDate ?? raw.age,
 ...
 * | PATCH | `/user/edit/{userId}` | Profil yangilash (`UserEditDTO`, `lib/updateUserProfile`) |
 *
 ...
 * DTO/serializatorni tekshiring. Yangilash: `PATCH /user/edit/{id}` (`updateUserProfile.ts`).
