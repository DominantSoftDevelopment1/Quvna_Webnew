    ...
    <div className="min-h-screen bg-[#0A0A0A] text-white">
      ...
      <div className="sticky top-0 z-10 bg-[#0A0A0A] border-b border-zinc-800">
        <div className="max-w-4xl mx-auto px-4 py-4 flex items-center gap-4">
          ...
          <h1 className="text-xl font-semibold">Davlatni tanlang</h1>
        </div>
      </div>
        ...
        <div className="mb-6">
          <div className="relative">
            <input
              ...
              className="w-full bg-zinc-900 border border-zinc-800 rounded-lg px-4 py-3 pl-12 text-white placeholder-zinc-500 focus:outline-none focus:border-emerald-500 transition-colors"
            />
            <svg
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-[#0A0A0A] border-t border-zinc-800">
        <div className="max-w-4xl mx-auto px-4 py-4">
          <button
            ...
            className="w-full bg-emerald-500 hover:bg-emerald-600 disabled:bg-zinc-800 disabled:text-zinc-500 text-white font-medium py-3 rounded-lg transition-colors"
          >
